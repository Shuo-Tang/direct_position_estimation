function [localMax, costMax] = ars2d_20ms(usrInfo, satInfo, rawSignal, caCodesTable,...
...
for i = 1:4
    r = generateCAFs_20ms_corr([posInit(i,:),usrInfo(3:end)], satInfo, rawSignal,...
    ...
    for it = 1: nIter-1
        ...
        J = generateCAFs_20ms_corr(usrInfo1, satInfo, rawSignal,...
                            caCodesTable, Doppler, corr);
    ...
    %% plot path
    % if ~exist('fig_path')
    %     fig_path = open('figs/gepsTest/abs_caf_middle_sol28_20ms.fig');
    %     hold on
    % end
