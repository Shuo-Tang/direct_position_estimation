function r = generateCAFs_pdpe_20ms_corr_satpos(usrInfo, satInfo, rawSignal, caCode, fd, corr)
...
for ims = 1: 20
    satPos = satInfo(1:3, :, ims+10)';
    satVel = satInfo(4:6, :, ims+10)';
    satCb = satInfo(7,:, ims+10);
    satPRN = satInfo(8, :, ims+10);
