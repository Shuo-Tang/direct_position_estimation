function [posEst, J_ant] = accRandomSearch2d_1ms(...
...
[localMax, r] = generalizedPatternSearch2d_1ms(usrInfo, satInfo, rawSignal, caCodesTable,...
                        Doppler, corr, searchD, stepSize, stepDecay, convergence);
usrInfo(1:2) = localMax;
J_ant = r;
cost(1) = r;
curJ(1) = J_ant;
...
for it = 1:nIter-1       
    ...
    usrInfo(1:2) = estPos(it,1:2) + d*(2*rand(2,1)-1)';
    [localMax, r] = generalizedPatternSearch2d_1ms(usrInfo, satInfo, rawSignal, caCodesTable,...
                        Doppler, corr, searchD, stepSize, stepDecay, convergence);
    usrInfo(1:2) = localMax;
    J = r;
