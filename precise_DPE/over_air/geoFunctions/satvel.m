function [satPositions, satClkCorr] = satvel(transmitTime, prnList, ...
                                             eph) 
%SAT Positions and Velocities Computation of satellite coordinates X,Y,Z at TRANSMITTIME for
