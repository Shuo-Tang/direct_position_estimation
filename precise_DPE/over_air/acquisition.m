...
%% Fine resolution frequency search =======================================
        ...
        %JAVI: the original Kay GPS RX gives the Doppler frequency with the
        %oposite sign in order to do the carrier wipeoff at tracking with
        %exp(j*2*pi*Doppler). This can cause confusion. This version uses the
        %correct Doppler sign and the carrier wipeoff is done as the usual
        %LO mix with exp(-j*2*pi*Doppler)
