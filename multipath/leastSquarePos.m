function [pos, el, az, dop, Q] = leastSquarePos(satpos, obs, settings)
...
pos     = zeros(4, 1);
X       = satpos;
nmbOfSatellites = settings.numberOfChannels;%size(satpos, 2);
...
for iter = 1:nmbOfIterations
    ...
    for i = 1:nmbOfSatellites
        ...
        omc(i) = (obs(i) - norm(Rot_X - pos(1:3), 'fro') - pos(4) - trop - iono);
